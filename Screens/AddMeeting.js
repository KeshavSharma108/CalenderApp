    ...
    return (
        <View style={Styles.mainContainer}>
            ...
            <ScrollView>
                ...
                <TouchableOpacity style={Styles.createButton} onPress={() => navigation.goBack()}><Text style={{ color: 'white' }}>Create</Text></TouchableOpacity>
                <View>
                ...
                <View style={{ marginTop: 20, }}>
                    ...
                    <View style={Styles.container2}>
                        ...
                        <View style={{ left: 70, marginTop: 10 }}>
                            <Text>
                                |
                            </Text>
                            <Text>
                        ...
                        <View style={{ left: 240, }}>
                            <TouchableOpacity style={Styles.dateBox2} onPress={showTimePicker}>
                                <Text>Time {selectTime && moment(selectTime).format('HH:mm a')}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={Styles.dateBox2} onPress={showTimePicker2} >
                                <Text>Time {selectTime2 && moment(selectTime2).format('HH:mm a')}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
